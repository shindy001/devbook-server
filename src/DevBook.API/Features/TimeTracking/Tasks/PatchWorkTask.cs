...
{
	public async Task<FieldResult<WorkTaskDto, NotFoundError>> PatchWorkTask(PatchWorkTaskCommand input, IExecutor executor, IMapper mapper, CancellationToken cancellationToken)
	{
